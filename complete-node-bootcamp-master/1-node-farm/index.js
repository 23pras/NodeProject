...
// reading temp-overview html for once.
...
// reading the FILE DATA Only once.
const dataObj = JSON.parse(data);

const slugs = dataObj.map((el) => slugify(el.productName), { lower: true }); // convert every objects productName into slug for the url.
